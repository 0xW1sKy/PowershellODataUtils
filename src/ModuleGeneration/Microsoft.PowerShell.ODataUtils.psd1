...
@{
    ...
    Description       = 'Generates CDXML modules that contain cmdlets to manage OData and Redfish endpoints.'
    ...
    FunctionsToExport = @('Export-ODataEndpointProxy')
